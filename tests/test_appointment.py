...
def appointment_can_return_correct_date(self) -> None:
    """
...
def appointment_returns_correct_event_name(self) -> None:
    """
...
def appointment_returns_correct_phone_number(self) -> None:
    """
...
def appointment_returns_correct_location(self) -> None:
    """
...
def appointment_returns_correct_message(self) -> None:
